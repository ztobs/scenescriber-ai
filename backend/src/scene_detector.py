...
class SceneDetector:
                            ...
                            scenes.append(
                                {
                                    ...
                                    - similarity,  # Higher difference = higher confidence
                                    "theme_applied": None,
                                }
                            )
    ...
    def _get_video_info(self, video_path: str) -> Dict[str, Any]:
        ...
        try:
            ...
            video_info = {"duration": 0, "fps": 30, "width": 0, "height": 0}
    ...
    def extract_keyframes(
        self, video_path: str, scenes: List[Dict[str, Any]], frames_per_scene: int = 3
    ) -> List[Dict[str, Any]]:
